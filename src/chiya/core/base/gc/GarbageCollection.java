...
public class GarbageCollection {
	...
	/** 清除的方法 */
	private VoidNoParamFunction function;
	 ...
	 * @param function 回收方法
	 */
	public GarbageCollection(VoidNoParamFunction function) {
	 ...
	 */
	public GarbageCollection(VoidNoParamFunction function, int timeInterval) {
		setFunction(function);
	 ...
	 * @param function 回收方法
	 */
	public void setFunction(VoidNoParamFunction function) {
