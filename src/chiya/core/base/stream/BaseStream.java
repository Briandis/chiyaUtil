...
public abstract class BaseStream<T, E> {
	 ...
	 * @return Stream<T> 操作流
	 */
	public E sort(GenericGenericFunction<? super T, ? extends Date> method) {
	 ...
	 * @return Stream<T> 操作流
	 */
	public E sortNullIsMax(GenericGenericFunction<? super T, ? extends Date> method) {
	 ...
	 * @return Stream<T> 操作流
	 */
	public E sortDesc(GenericGenericFunction<? super T, ? extends Date> method) {
	 ...
	 * @return Stream<T> 操作流
	 */
	public E sortDescNullIsMax(GenericGenericFunction<? super T, ? extends Date> method) {
