...
import chiya.core.base.function.BooleanNoParamFunction;
...
public class ThreadUtil {
	 ...
	 */
	public static void doubleCheckLock(BooleanNoParamFunction booleanFunction, Object lock, VoidNoParamFunction function) {
	 ...
	 * @param function        执行的方法
	 */
	public static void doubleCheckLock(BooleanNoParamFunction booleanFunction, Lock lock, VoidNoParamFunction function) {
		if (booleanFunction.task()) {
			lock.lock();
			try {
				if (booleanFunction.task()) { function.task(); }
	 ...
	 * @param function 执行的方法
	 */
	public static void lock(Lock lock, VoidNoParamFunction function) {
		lock.lock();
		try {
			function.task();
		} finally {
	 ...
	 * @param function 执行的方法
	 */
	public static <T> T lock(Lock lock, GenericNoParamFunction<T> function) {
		lock.lock();
		try {
